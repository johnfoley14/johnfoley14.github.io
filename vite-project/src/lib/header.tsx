...
import { toggleTheme, loadTheme } from "./toggle-theme";
    ...
    <div className="header">
      <ul>
        ...
        <li className="justify-end">
          <div
            className="p-1 m-1 rounded mr-4 flex flex-row"
            onClick={handleOpenModal}
          >
            <div className="text-black pr-1">Request CV</div>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <div className="p-1 rounded mr-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
